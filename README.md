...
- [kubernetes-sigs/cluster-api-provider-gcp @ v1.1.2](https://github.com/kubernetes-sigs/cluster-api-provider-gcp/releases/tag/v1.1.2) (6 days ago)
...
- **[arnvald/viml-to-lua](https://github.com/arnvald/viml-to-lua)** (1 day ago)
- **[kubernetes-sigs/cluster-api-provider-aws](https://github.com/kubernetes-sigs/cluster-api-provider-aws)** - Kubernetes Cluster API Provider AWS provides consistent deployment and day 2 operations of &#34;self-managed&#34; and EKS Kubernetes clusters on AWS. (6 days ago)
- **[dntosas/capi2argo-cluster-operator](https://github.com/dntosas/capi2argo-cluster-operator)** - Capi2Argo Cluster Operator (CACO) can be deployed on a CAPI Management cluster and dynamically convert Workload cluster credentials into Argo Cluster definitions. (6 days ago)
