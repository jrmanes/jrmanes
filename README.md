...
- [celestiaorg/celestia-app](https://github.com/celestiaorg/celestia-app) - PoS chain powered by celestia-core (fork of tendermint) and the the cosmos-sdk (4 days ago)
...
- [celestiaorg/celestia-app @ v0.12.0-rc4](https://github.com/celestiaorg/celestia-app/releases/tag/v0.12.0-rc4) (3 days ago)
...
- [feat: Prevent any errors when creating the data folder](https://github.com/celestiaorg/celestia-app/pull/1303) on [celestiaorg/celestia-app](https://github.com/celestiaorg/celestia-app) (4 days ago)
