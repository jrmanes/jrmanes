...
- [celestiaorg/networks](https://github.com/celestiaorg/networks) -  (1 day ago)
...
- [celestiaorg/go-fraud @ v0.2.0](https://github.com/celestiaorg/go-fraud/releases/tag/v0.2.0) (3 days ago)
- [celestiaorg/go-header @ v0.3.0](https://github.com/celestiaorg/go-header/releases/tag/v0.3.0) (3 days ago)
...
- [chore(nodebuilder/p2p)!: Bump arabica-10](https://github.com/celestiaorg/celestia-node/pull/2639) on [celestiaorg/celestia-node](https://github.com/celestiaorg/celestia-node) (1 day ago)
- [feat(arabica-10): update the genesis file](https://github.com/celestiaorg/networks/pull/341) on [celestiaorg/networks](https://github.com/celestiaorg/networks) (2 days ago)
